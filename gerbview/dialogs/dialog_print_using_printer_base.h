...
class DIALOG_PRINT_USING_PRINTER_BASE : public DIALOG_SHIM
{
	...
	public:
		...
		DIALOG_PRINT_USING_PRINTER_BASE( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = _("Print"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 551,450 ), long style = wxDEFAULT_DIALOG_STYLE|wxRESIZE_BORDER ); 
